...
const RAW_ITEM_DEFINITIONS: readonly ItemDefinition[] = [
  ...
  },
  {
    ...
    name: 'Rabbit Meat',
    description:
      'A small cut of lean rabbit meat. Useful for simple cooking and light travel meals.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 1,
    tags: ['loot', 'material', 'rabbit', 'meat', 'cooking'],
  },
  {
    id: 'rabbit_foot',
    name: 'Rabbit Foot',
    description:
      'A lucky rabbit foot used for charms, folk alchemy, and fortune-touched trinkets.',
    category: 'material',
    rarity: 'rare',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 5,
    tags: ['loot', 'material', 'rabbit', 'luck', 'charm', 'alchemy'],
  },
  {
    id: 'hawk_feather',
    name: 'Hawk Feather',
    description:
      'A firm feather from a razorwing hawk. Useful for arrows, light craft, and wind-aspected trinkets.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 1,
    tags: ['loot', 'material', 'hawk', 'feather', 'arrow', 'crafting'],
  },
  {
    id: 'hawk_egg',
    name: 'Hawk Egg',
    description:
      'A prized hawk egg used by cooks, alchemists, and traders who value rare wild ingredients.',
    category: 'material',
    rarity: 'uncommon',
    stackable: true,
    maxStackSize: 30,
    sellPriceBronze: 4,
    tags: ['loot', 'material', 'hawk', 'egg', 'cooking', 'alchemy'],
  },
  {
    id: 'boar_meat',
    name: 'Boar Meat',
  ...
  },
  {
    ...
    name: 'Wolf Meat',
    description:
      'Lean, gamey wolf meat. Harsh on its own, but useful for survival cooking and strong rations.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 2,
    tags: ['loot', 'material', 'beast', 'wolf', 'meat', 'cooking'],
  },
  {
    id: 'wolf_pelt',
    name: 'Wolf Pelt',
  ...
  },
  {
    ...
    name: 'Bear Meat',
    description:
      'A heavy cut of bear meat. Valuable for hearty meals and stamina-rich cooking.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 4,
    tags: ['loot', 'material', 'beast', 'bear', 'meat', 'cooking'],
  },
  {
    id: 'bear_claw',
    name: 'Bear Claw',
    description:
      'A heavy claw from a forest bear. Useful for weapons, talismans, and brutal craftwork.',
    category: 'material',
    rarity: 'rare',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 8,
    tags: ['loot', 'material', 'beast', 'bear', 'claw', 'crafting'],
  },
  {
    id: 'goblin_ear',
    name: 'Goblin Ear',
  ...
  },
  {
    ...
    name: 'Mineral Dust',
    description:
      'Fine mineral dust left behind by ore mites. Useful for alchemy, refining, and early enchantment work.',
    category: 'material',
    rarity: 'rare',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 6,
    tags: ['loot', 'material', 'mineral', 'alchemy', 'refining', 'crafting'],
  },
  {
    id: 'rough_wood',
    name: 'Rough Wood',
