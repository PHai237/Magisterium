...
const RAW_ITEM_DEFINITIONS: readonly ItemDefinition[] = [
  ...
  },
  {
    ...
    name: 'Tough Sinew',
    description:
      'Strong beast sinew that can bind handles, reinforce seams, or serve as rough bowstring material.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 3,
    tags: ['loot', 'material', 'beast', 'sinew', 'crafting'],
  },
  {
    id: 'goblin_ear',
    name: 'Goblin Ear',
  ...
  },
  {
    ...
    name: 'Bent Rivet',
    description:
      'A small warped rivet pulled from scrap equipment. Still useful when reforged or hammered flat.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 1,
    tags: ['loot', 'material', 'goblin', 'metal', 'smithing'],
  },
  {
    id: 'dull_iron_shard',
    name: 'Dull Iron Shard',
    description:
      'A blunt shard of low-grade iron. It can be smelted, reforged, or used in rough early equipment recipes.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 2,
    tags: ['material', 'metal', 'iron', 'smithing', 'crafting'],
  },
  {
    id: 'cracked_blade',
    name: 'Cracked Blade',
  ...
  },
  {
    ...
    maxStackSize: 99,
    sellPriceBronze: 1,
    tags: ['material', 'wood', 'common_wood', 'carpentry', 'crafting'],
  },
  {
    id: 'common_wood',
    name: 'Common Wood',
    description:
      'A simple worked wood piece used as a stable placeholder material for early crafting recipes.',
    category: 'material',
    rarity: 'common',
    stackable: true,
    maxStackSize: 99,
    sellPriceBronze: 1,
    tags: ['material', 'wood', 'rough_wood', 'carpentry', 'crafting'],
  },
  {
    id: 'basic_thread',
    name: 'Basic Thread',
